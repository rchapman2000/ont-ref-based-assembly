...
process QC_Report {
    ...
    if [[ -s ${reads} ]]; then
        NanoPlot --fastq ${reads} -o ${dirName}
    fi
    """
}
...
process Porechop_Trimming {
    ...
    */
    ...
    summary="${existingSummary},\$avg_trimmed_read_len"
    """
}
...
process Length_Filtering {
    ...
    output:
        tuple val(base), file("${base}-length-filtered.fastq")
